class Caesar:
    ...
    def __init__(self, key):
        ...
        lowercase_decode = {self.alphabet[(i+key)%len(self.alphabet)]:self.alphabet[i] for i in range(len(self.alphabet))}
        uppercase_decode = {self.alphabet[(i+key)%len(self.alphabet)].upper():self.alphabet[i].upper() for i in range(len(self.alphabet))}
